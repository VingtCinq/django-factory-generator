...
class FactoryFieldGenerator:
    ...
    def is_ignored(self):
        ...
        if self.field_class in IGNORE_FIELDS:
            return True
        if not self.field.editable and getattr(
            settings, "FACTORY_IGNORE_NON_EDITABLE_FIELDS", True
        ):
            return True
        return False
    ...
    def base_context(self):
        ...
        """
        res = {"field": self.field, "model_name": self.model.__name__}
        return res
    ...
    def render_choices_list(self):
        ...
        return render_to_string(
            "factory_generator/choiceslist.py-tpl", self.base_context
        )
...
class FactoryModelGenerator(PathMixin):
    ...
    def context_init(self):
        ...
        return {"module": module_path, "factory": self.factory_name}
    ...
    def context_base(self):
        ...
        for field in self.fields:
            ...
            if res["unique"]:
                res["unique_kwargs"] = (
                    ", ".join("%r" % key for key in res["unique"]) + ","
                )
    ...
    def render_base(self):
        ...
        """
        return render_to_string(
            "factory_generator/base-factory.py-tpl", self.context_base
        )
